    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final allSurgeries = snapshot.data!.docs.where((doc) {
          ...
          final surgeryType =
              (data['surgeryType'] ?? '').toString().toLowerCase();
          ...
          if (_endDate != null) {
            matchesDateRange = matchesDateRange &&
                surgeryDate.isBefore(_endDate!.add(const Duration(days: 1)));
          }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: InkWell(
                onTap: () {
                  showSurgeryDetailBottomSheet(context, allSurgeries[index].id);
                },
                borderRadius: BorderRadius.circular(12),
                child: Padding(

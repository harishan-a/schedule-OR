  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .where('status',
              isEqualTo: 'Scheduled') // Filter for scheduled surgeries only
                      ...
                      content: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                'Nurses: ${(surgery['nurses'] as List).join(", ")}'),
                            if (surgery['technologists'] != null &&
                                (surgery['technologists'] as List).isNotEmpty)
                              Text(
                                  'Technologist: ${(surgery['technologists'] as List).join(", ")}'),
                            Text('Status: ${surgery['status']}'),
                            // Optional notes section
                            if (surgery['notes'] != null &&
                                surgery['notes'].toString().isNotEmpty)

...
import '../../surgery/screens/filtered_surgeries.dart';
import '../../../shared/widgets/notification_badge.dart';
import '../../notifications/screens/notifications_screen.dart';
import '../../../services/notification_manager.dart';
import '../../../features/surgery/utils/surgery_detail_utils.dart';
import '../../../shared/widgets/user_avatar.dart';
import '../../surgery/screens/surgery_log.dart';
import '../../schedule/screens/resource_check_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _userLastName = profile['lastName'] ?? '';
          _profileImageUrl = profile['profileImageUrl'] ?? '';
          _selectedDefaultAvatar = profile['selectedDefaultAvatar'] ?? '';
          _isLoading = false;
        });
      }
    } catch (e) {
  ...
  Widget _buildWelcomeBanner() {
    return Consumer<UserProfileProvider>(
      builder: (context, userProfileProvider, child) {
        ...
        final firstName = userProfile?.firstName ?? _userFirstName;
        final lastName = userProfile?.lastName ?? _userLastName;
        final profileImageUrl =
            userProfile?.profileImageUrl ?? _profileImageUrl;
        final defaultAvatar =
            userProfile?.selectedDefaultAvatar ?? _selectedDefaultAvatar;
  ...
  /// - Tappable cards that navigate to filtered surgery lists
                ...
                children: [
                  Expanded(
                    child: StatCard(
                      ...
                      color: Colors.blue,
                      icon: Icons.schedule,
                      onTap: () => _navigateToFilteredSurgeries('Scheduled'),
                    ),
                  ),
                  ...
                  Expanded(
                    child: StatCard(
                      ...
                      color: Colors.orange,
                      icon: Icons.sync,
                      onTap: () => _navigateToFilteredSurgeries('In Progress'),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: StatCard(
                      ...
                      onTap: () => _navigateToFilteredSurgeries('Completed'),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: StatCard(
                      ...
                      color: Colors.red,
                      icon: Icons.cancel,
                      onTap: () => _navigateToFilteredSurgeries('Cancelled'),
                    ),
                  ),
                ],
              ),
  ...
  /// - Surgery Log shortcut
  /// - Resource Check shortcut
                ...
                child: _buildActionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const SurgeryLogScreen(),
                      ),
                    );
                  },
                ),
  ...
  void _navigateToSurgeryDetails(String surgeryId) {
    showSurgeryDetailBottomSheet(context, surgeryId);
  }

  /// Navigates to the filtered surgeries screen
  void _navigateToFilteredSurgeries(String status) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FilteredSurgeriesScreen(status: status),
      ),
    );
  }
}

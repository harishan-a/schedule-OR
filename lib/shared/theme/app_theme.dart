...
class AppTheme extends InheritedWidget {
  ...
  ThemeData _createTheme(bool forceDark) {
    ...
    final primaryColor = forceDark
        ? Colors.blue[200]!
        : Colors.blue; // Lighter blue for dark mode
    final backgroundColor = forceDark
        ? const Color(0xFF121212)
        : Colors.white; // Material 3 background
    final surfaceColor =
        forceDark ? const Color(0xFF1E1E1E) : Colors.grey[50]!; // Surface color
    final onSurfaceColor =
        forceDark ? Colors.white : Colors.black; // Text/icon color on surface
    final secondaryColor = forceDark
        ? Colors.orange[200]!
        : Colors.orange; // Lighter orange for dark mode

    // Text theme configuration with accessibility scaling
    final textTheme =
        (forceDark ? ThemeData.dark() : ThemeData.light()).textTheme.copyWith(
              // Body text styles
              bodyLarge: TextStyle(
    ...
    final colorScheme = isHighContrast
        ? ColorScheme(
            ...
            onPrimary: forceDark
                ? Colors.black
                : Colors.white, // Better contrast in dark mode
            secondary: secondaryColor,
            onSecondary: forceDark
                ? Colors.black
                : Colors.white, // Better contrast in dark mode
            ...
            primaryContainer: forceDark
                ? primaryColor.withOpacity(0.2)
                : primaryColor
                    .withOpacity(0.1), // Slightly more visible in dark mode
            onPrimaryContainer: primaryColor,
            secondaryContainer: forceDark
        ...
        : ColorScheme.fromSeed(
            // Standard color scheme with Material 3 color generation
            ...
            primaryContainer: forceDark
                ...
                : primaryColor
                    .withOpacity(0.1), // Slightly more visible in dark mode
            onPrimaryContainer: forceDark
                ? Colors.white
                : primaryColor, // Better contrast in dark mode
            secondaryContainer: forceDark
                ? secondaryColor.withOpacity(0.2)
                : secondaryColor
                    .withOpacity(0.1), // Slightly more visible in dark mode
            onSecondaryContainer: forceDark
                ? Colors.white
                : secondaryColor, // Better contrast in dark mode
          );
    ...
    return ThemeData(
      ...
      cardTheme: CardTheme(
        ...
        elevation: forceDark
            ? 0
            : 1, // Reduced elevation in dark mode for better contrast
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(12), // Consistent corner radius
          side: forceDark
              ? BorderSide(
                  color: colorScheme.onSurface
                      .withOpacity(0.1)) // Subtle border in dark mode
              : BorderSide.none,
        ),
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 16, vertical: 12), // Comfortable touch target
          shape: RoundedRectangleBorder(
      ...
      snackBarTheme: SnackBarThemeData(
        backgroundColor:
            forceDark ? colorScheme.surface : colorScheme.onSurface,
      ...
      pageTransitionsTheme: const PageTransitionsTheme(
        builders: {
          TargetPlatform.android:
              ZoomPageTransitionsBuilder(), // Zoom + fade for Android
          TargetPlatform.iOS:
              CupertinoPageTransitionsBuilder(), // iOS-style transitions
